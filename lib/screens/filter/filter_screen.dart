                    ...
                    child: Chip(
                      label: Text("New Today",
                          style: context.theme.bodyMedium!.copyWith(
                              color:
                                  sortby == "New Today" ? context.colorScheme.onPrimary
                                              : context.colorScheme.primary)),
                      backgroundColor:
                          sortby == "New Today"  ? context.colorScheme.primary
                                            : context.colorScheme.onPrimary,
                      shape: const StadiumBorder(
                          side: BorderSide(color: Color(0xffCCCCCC))),
                    ),
                  ...
                  GestureDetector(
                    ...
                    child: Chip(
                      label: Text(
                        ...
                        style: context.theme.bodyMedium!.copyWith(
                            color:
                                sortby == "Top Seller" ? context.colorScheme.onPrimary
                                              : context.colorScheme.primary),
                      ),
                      backgroundColor:
                          sortby == "Top Seller"  ? context.colorScheme.primary
                                            : context.colorScheme.onPrimary,
                      shape: const StadiumBorder(
                          side: BorderSide(color: Color(0xffCCCCCC))),
                    ),
