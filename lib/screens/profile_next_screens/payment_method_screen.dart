...
import 'package:rika_ecomm_app/screens/profile_next_screens/add_card_Detail_screen.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child: Text(
                          '+',
                          style: TextStyle(fontSize: 28, color:context.colorScheme.secondary),
                        ),
                      ),
                      SizedBox(
                        width: 5,
                      ...
                      Text('Add Card',
                          style: context.theme.titleMedium!.copyWith(color: context.colorScheme.primary)),
                    ],
                  ),
                ),
              ),
