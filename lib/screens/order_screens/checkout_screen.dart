...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void dispose() {
    super.dispose();
    getIt.resetLazySingleton<GetOrderAddressCubit>();
  }
...
class AddressContainer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<GetOrderAddressCubit, Result<Addresses?>>(
      builder: (context, state) {
        if (state.isLoading) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text("AddressLine 1 : ", style: context.theme.titleMedium),
                      ...
                      Row(
                        children: [
                          Text("AddressLine 2 : ", style: context.theme.titleMedium),
          ...
          return Column(
            children: [SizedBox.shrink(), const SizedBox(height: 20), AddAddressButton()],
          );
        }
      },
    );
...
class _PlaceOderButtonState extends State<PlaceOderButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final addressSelected = orderState.state.data?.id; // Extract the address ID here.
      ...
      children: [
        ...
        BlocListener<PostPlacedOrderCubit, Result<Order>>(
                  ...
                  return OrderPlacedAlert(
                    onDone: () {
                      ...
                      Navigator.of(context)
                          .pushNamedAndRemoveUntil(NavRoutes.order.path, (route) => route.isFirst);
                    },
                  );
                },
              );
          ...
          child: ElevatedButton(
              ...
              onPressed: (cartState == null || cartState.isEmpty || addressSelected == null)
                  ? null
                  : () {
                      print(
              ...
              child: Padding(
                ...
                child: Text("Place order",
                    style:
                        context.theme.titleMedium!.copyWith(color: context.colorScheme.onPrimary)),
              )),
        )
      ],
    );
...
class PaymentMethodButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => const PaymentMethodScreen()));
      },
      child: Container(
        height: 50,
        decoration: BoxDecoration(
...
class ChangeAddressButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.of(context).pushNamed(NavRoutes.addressList.path);
      },
      child: Container(
        height: 50,
        decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 20, color: context.colorScheme.secondary),
                ),
                const SizedBox(height: 20),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
